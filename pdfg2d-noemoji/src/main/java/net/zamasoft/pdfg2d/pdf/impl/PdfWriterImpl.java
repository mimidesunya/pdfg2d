 ...
 * @version $Id: PdfWriterImpl.java 1565 2018-07-04 11:51:25Z miyabe $
 */
	...
	public void finish() throws IOException {
		...
		if (vp != null) {
			...
			if (vp.getPickTrayByPDFSize()) {
				if (this.params.getVersion() < PdfParams.VERSION_1_7) {
					throw new UnsupportedOperationException("ViewerPreferenceのPickTrayByPDFSizeは PDF 1.7 以降で使用できます。");
				}
