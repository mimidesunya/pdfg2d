...
public interface Table {
	...
	public static final int CFF = 0x43464620; // PostScript font program
	...
	public static final int GDEF = 0x47444546; // Glyph definition data

	// [OpenType]

	public static final int GPOS = 0x47504f53; // Glyph positioning data

	// [OpenType]

	public static final int GSUB = 0x47535542; // Glyph substitution data
	...
	public static final int MMFX = 0x4d4d4658; // Multiple master font metrics

	// [PostScript]

	public static final int MMSD = 0x4d4d5344; // Multiple master supplementary

	// data [PostScript]

	public static final int OS_2 = 0x4f532f32; // OS/2 and Windows specific
	...
	public static final int cmap = 0x636d6170; // character to glyph mapping
	...
	public static final int fvar = 0x66766172; // Apple's font variations table

	// [PostScript]

	public static final int gasp = 0x67617370; // grid-fitting and scan
	...
	public static final int VORG = 0x564f5247; // Vertical Origin Table
	...
	public static final short encodingBMP = 3;

	public static final short encodingNonBMP = 4;

	public static final short encodingUVS = 5;

	// Microsoft Encoding IDs
	public static final short encodingUndefined = 0;

	public static final short encodingUCS2 = 1;
